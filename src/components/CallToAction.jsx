...
export default function CallToAction() {
  return (
    <div
      className="bg-[url(/images/iteration-1-images/home-banner.png)] font-[Barlow] w-screen h-screen bg-cover bg-center flex flex-col justify-top items-center"
    >
      <img
        src={logo}
        alt="logo"
      ...
      />
      <p
        className="font-light text-7xl text-white text-center"
      >
